...
<br>
<h2>Procedure</h2>
This process is complex, laborious and prone to failure, please pay attention to each step to minimize mistakes.
...
graph TD;
    ...
    C[NAS_IP:/path]--"$ sudo tar xvf diskless.tar"-->B[NAS_IP:/path/diskless];
